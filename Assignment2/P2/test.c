...
// generic single-threaded map implementation using void* and pointer
// arithmetics.
...
void init_map_argument(struct map_argument *argument, void **things,
                       void **results, void *(*f)(void *), int from, int to) {
  argument->f = f;
