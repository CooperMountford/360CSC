...
void swap(struct node* ref1, struct node* ref2) {
   ...
   if(ref1 == ref2 || ref1 == NULL || ref2 == NULL)
      return;

   struct node* nx1 = ref1->next;
   struct node* nx2 = ref2->next;
   struct node* px1 = ref1->prev;
   struct node* px2 = ref2->prev;



   // ref1 beside, infront ref2
   if(next(ref1) == prev(ref2)) {
      printf("CASE1  ");
      px1 = ref2;
      nx2 = ref1;
   }
   // ref2 beside, infront ref1
   else if(next(ref2) == prev(ref1)) {
      printf("CASE2  ");
      px2 = ref1;
      nx1 = ref2;
   }
